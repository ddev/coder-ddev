...
#
# Required env vars (set on coder_agent.env in drupal-contrib/template.tf):
...
#   PROJECT_NAME      - DDEV project name (from data.coder_parameter.project_name.value).
#   PROJECT_TYPE      - DDEV project type, e.g. drupal/php (from data.coder_parameter.project_type.value).
...
# PROJECT_NAME is injected via coder_agent.env
# PROJECT_TYPE is injected via coder_agent.env
