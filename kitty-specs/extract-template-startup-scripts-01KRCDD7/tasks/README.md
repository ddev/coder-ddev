...
branch_strategy: "Planning artifacts were generated on extract-template-startup-scripts; completed changes must merge back into extract-template-startup-scripts."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
